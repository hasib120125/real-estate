...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('public/vendor/admin/pnotify/pnotify.custom.min.css') }}">

    <!-- Admin Global CSS -->
    <link rel="stylesheet" href="{{ asset('public/vendor/admin/style.css') . '?v=' . vTime() }}">
...
<body class="hold-transition {{ config('larapen.admin.skin') }} sidebar-mini">
      ...
      <footer class="main-footer">
        @if (config('larapen.admin.show_powered_by'))
            <div class="pull-right hidden-xs">
                {{ trans('admin::messages.powered_by') }} <a target="_blank" href="http://www.technobari.com">TechnoBari</a>.
            </div>
    ...
    <script>window.jQuery || document.write('<script src="{{ asset('public/vendor/adminlte') }}/plugins/jQuery/jQuery-2.2.0.min.js"><\/script>')</script>
    <!-- Bootstrap 3.3.5 -->
