		...
		<section class="sidebar">
			...
			<div class="user-panel">
				<div class="pull-left image">
					<img src="{{ Gravatar::fallback(url('public/images/user.jpg'))->get(Auth::user()->email) }}" class="img-circle" alt="User Image">
				</div>
			...
			<ul class="sidebar-menu">
				...
				<li class="treeview">
					...
					<ul class="treeview-menu">
                        ...
                        <li><a href="{{ url($adminBase . '/picture') }}"><i class="fa fa-picture-o"></i> <span>{{ __t('pictures') }}</span></a></li>
						<li><a href="{{ url($adminBase . '/p_type') }}"><i class="fa fa-cog"></i> <span>{{ __t('ad types') }}</span></a></li>
						<li><a href="{{ url($adminBase . '/field') }}"><i class="fa fa-list-alt"></i> <span>{{ __t('custom fields') }}</span></a></li>
					</ul>
				</li>
