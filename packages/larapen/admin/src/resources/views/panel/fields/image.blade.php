...
@if ($xPanel->checkIfFieldIsFirstOfItsType($field, $fields))
    ...
    {{-- YOUR CSS HERE --}}
    <link href="{{ asset('public/vendor/admin/cropper/dist/cropper.min.css') }}" rel="stylesheet" type="text/css" />
    <style>
        .hide {
            display: none;
        }
    ...
    {{-- YOUR JS HERE --}}
    <script src="{{ asset('public/vendor/admin/cropper/dist/cropper.min.js') }}"></script>
    <script>
