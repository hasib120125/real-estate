...
@if ($xPanel->checkIfFieldIsFirstOfItsType($field, $fields))
    ...
    <script type="text/javascript" src="{{ asset('public/vendor/adminlte/plugins/daterangepicker/moment.min.js') }}"></script>
    ...
    @if ($field_language !== 'en')
        <script charset="UTF-8" src="{{ asset('public/vendor/adminlte/plugins/datepicker/locales/bootstrap-datepicker.'.$field_language.'.js') }}"></script>
