...
@section('after_styles')
    <link href="{{ asset('public/vendor/admin/nestedSortable/nestedSortable.css') }}" rel="stylesheet" type="text/css" />
@endsection
...
@section('after_scripts')
    ...
    <script src="{{ url('public/vendor/admin/nestedSortable/jquery.mjs.nestedSortable2.js') }}" type="text/javascript"></script>
    ...
    <script type="text/javascript">
        jQuery(document).ready(function($) {
            ...
            $('.sortable').nestedSortable({
                ...
                maxLevels: {{ $xPanel->reorder_max_level or 3 }},
