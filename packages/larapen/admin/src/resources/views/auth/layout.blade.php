...
<div class="login-box">
    ...
    <div class="login-logo">
        <a href="{{ url('/') }}">
            <img src="{{ \Storage::url(config('settings.app_logo')) . getPictureVersion() }}" style="width:200px; height:auto;">
        </a>
    </div>
    <!-- /.login-logo -->
...
<!-- jQuery 2.2.3 -->
<script src="{{ asset('public/vendor/adminlte/') }}/plugins/jQuery/jquery-2.2.3.min.js"></script>
<!-- Bootstrap 3.3.6 -->
