...
return [
    ...
    'purchase_code_checker_url' => 'http://api.technobari.com/envato.php?purchase_code=',
    ...
    'maps' => [
        'path'    => public_path('public/images/maps') . '/',
        'urlBase' => 'public/images/maps/',
    ],
