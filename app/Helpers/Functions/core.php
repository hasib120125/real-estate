 ...
 * @return mixed|string
 */
function auto_link($str, $attributes = [])
{
...
{
    if (file_exists(public_path() . '/public/images/flags/16/' . strtolower($countryCode) . '.png')) {
        $phoneIcon = '<img src="' . url('public/images/flags/16/' . strtolower($countryCode) . '.png') . getPictureVersion() . '" style="padding: 2px;">';
    } else {
