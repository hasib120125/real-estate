...
class Category extends BaseModel
{
    ...
    */
    ...
    public function getNameHtml()
    {
        ...
        $cfUrl = url(config('larapen.admin.route_prefix', 'admin') . '/category/' . $this->id . '/field');
        ...
        $out .= '<a class="btn btn-xs btn-info" href="' . $cfUrl . '"><i class="fa fa-plus"></i> ' . ucfirst(__t('custom fields')) . '</a>';
        $out .= '</span>';
