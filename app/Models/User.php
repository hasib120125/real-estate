    ...
    */
    ...
    public function getCountryHtml()
    {
        ...
        if (file_exists(public_path($iconPath))) {
            $iconPath1 = 'public/images/flags/16/' . strtolower($this->country_code) . '.png';
            $out = '';
            $out .= '<a href="' . url('/') . '?d=' . $this->country_code . '" target="_blank">';
            $out .= '<img src="' . url($iconPath1) . getPictureVersion() . '" data-toggle="tooltip" title="' . $this->country_code . '">';
            $out .= '</a>';
            return $out;
        } else {
