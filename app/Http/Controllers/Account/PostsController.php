...
class PostsController extends AccountBaseController
{
    ...
    public function getPage($pagePath)
    {
        ...
        switch ($pagePath) {
            ...
            case 'shared-properties':
                return $this->getSharedProperties();
                break;
            default:
                abort(404);
        }
     ...
     */
     public function user_guidline(){
            return view('home.inc.user-guidline');
    }
    ...
    public function getFriendlist()
    {
        ...
        // Meta Tags
        MetaTag::set('title', 'Friendlist - Jamidari.com');
        MetaTag::set('description', t('My favourite ads on :app_name', ['app_name' => config('settings.app_name')]));

        view()->share('pagePath', 'friendlist');

        return view('account.friendlist', $data);
    }
    ...
    public function getSharedProperties()
    {
        ...
        // Meta Tags
        MetaTag::set('title', 'Shared Properties - Jamidari.com');
        MetaTag::set('description', t('My favourite ads on :app_name', ['app_name' => config('settings.app_name')]));

        view()->share('pagePath', 'shared-properties');

        return view('account.shared-properties', $data);
    }
