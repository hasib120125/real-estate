							...
							<div class="col-md-5 col-xs-4 col-xxs-12">
								<h3 class="no-padding text-center-480 useradmin">
									<a href="{{URL::to('user',$user->id)}}">
										<img class="userImg" src="{{ URL::to($user->avatar) }}" alt="user">&nbsp;
										{{ $user->name }}
									</a>
								</h3>
							</div>
									...
									<div class="panel-body">
										<form name="details" class="form-horizontal" role="form" method="POST" action="{{ url()->current() }}" enctype="multipart/form-data">
											...
											<div class="form-group required <?php echo (isset($errors) and $errors->has('about')) ? 'has-error' : ''; ?>">
												<label class="col-sm-3 control-label" for="about">Title/About </label>
												<div class="col-sm-9">
													<input type="text" name="about" id="about" class="form-control" value="{{ old('about', $user->about) }}">
												</div>
											</div>
											...
											<!-- avatar -->
											<div class="form-group required <?php echo (isset($errors) and $errors->has('avatar')) ? 'has-error' : ''; ?>">
												<label class="col-sm-3 control-label" for="avatar">Avatar </label>
												<div class="col-sm-9">
													<input type="file" name="avatar" id="avatar"><br>
													<img style="width:100px;" src="{{URL::to($user->avatar)}}" alt="Avatar Not Available">
												</div>
											</div>

											<!-- profile_banner -->
											<div class="form-group required <?php echo (isset($errors) and $errors->has('profile_banner')) ? 'has-error' : ''; ?>">
												<label class="col-sm-3 control-label" for="profile_banner">Profile Banner </label>
												<div class="col-sm-9">
													<input type="file" name="profile_banner" id="profile_banner"><br>
													<img style="width:200px;" src="{{URL::to($user->profile_banner)}}" alt="Profile Banner Not Available">
												</div>
											</div>
											...
											<div class="form-group required <?php echo (isset($errors) and $errors->has('address')) ? 'has-error' : ''; ?>">
												<label class="col-sm-3 control-label" for="address">Company Address </label>
												<div class="col-sm-9">
											...
											<div class="form-group required <?php echo (isset($errors) and $errors->has('company_description')) ? 'has-error' : ''; ?>">
												<label class="col-sm-3 control-label" for="company_description">Company Description </label>
												<div class="col-sm-9">
													<textarea name="company_description" id="company_description" cols="30" rows="5" class="form-control">{{ old('company_description', $user->company_description) }}</textarea>
												</div>
											</div>

											<!-- company_logo -->
											<div class="form-group required <?php echo (isset($errors) and $errors->has('company_logo')) ? 'has-error' : ''; ?>">
												<label class="col-sm-3 control-label" for="company_logo">Company Logo </label>
												<div class="col-sm-9">
													<input type="file" name="company_logo" id="company_logo"><br>
													<img style="width:100px;" src="{{URL::to($user->company_logo)}}" alt="Company Logo Not Available">
												</div>
											</div>
