							...
							<form name="listForm" method="POST" action="{{ lurl('account/'.$pagePath.'/delete') }}">
								...
								<table id="addManageTable" class="table table-striped table-bordered add-manage-table table demo" data-filter="#filter" data-filter-text-only="true">
									...
									foreach($posts as $key => $post):
                                    	...
                                    	// Get country flag
                                    	$iconPath = 'public/images/flags/16/' . strtolower($post->country_code) . '.png';
									?>
									<tr>
...
@section('after_scripts')
	<script src="{{ url('public/assets/js/footable.js?v=2-0-1') }}" type="text/javascript"></script>
	<script src="{{ url('public/assets/js/footable.filter.js?v=2-0-1') }}" type="text/javascript"></script>
